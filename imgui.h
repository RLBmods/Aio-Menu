...
namespace ImGui
{
	...
	IMGUI_API bool          InputTextWithHint(const char* label, const char* hint, const char* icos, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
