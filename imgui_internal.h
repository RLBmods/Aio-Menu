...
//#endif
    ...
    IMGUI_API bool          Button1(const char* label, const char* ico, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ButtonSellect(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags);
    IMGUI_API bool          ButtonSellected(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags);
    IMGUI_API bool          Tab(bool selected, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ButtonCyrcle(const char* label, const char* icos, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ButtonIcons(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags);
    IMGUI_API bool          CircleAnim(const char* label);
    ...
    // InputText
    IMGUI_API bool          InputTextEx(const char* label, const char* hint, const char* icos, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
